  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col pt-16 md:pt-20">
      <SEO 
        ...
        description="Актуальный прайс-лист на электромонтажные услуги в Алматы. Прозрачные цены, стоимость согласуется до начала работ."
        ...
        <div className="container mx-auto">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="bg-white rounded-2xl p-6 mb-10 shadow-lg border border-gray-100 flex items-center gap-6">
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-900 mb-1">Выезд входит в стоимость заказа</h3>
                <p className="text-gray-500 text-sm">Точная стоимость работ согласуется после осмотра и до начала выполнения.</p>
              </div>
            </div>
