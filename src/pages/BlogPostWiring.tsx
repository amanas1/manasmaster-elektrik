            ...
            <div className="p-8 md:p-12 lg:px-16 text-gray-700 font-medium leading-relaxed">
              ...
              <div className="bg-red-50 border-l-4 border-[#DC2626] p-6 rounded-r-2xl my-8">
                <div className="flex items-start gap-3">
                  ...
                  <p className="m-0 font-medium">Ваша проводка старше 20 лет? Независимо от признаков — проведите профилактическую диагностику. Алюминиевые провода имеют ограниченный срок службы. Я приеду и оценю состояние проводки бесплатно при заказе ремонта.</p>
                </div>
              </div>
              ...
              <div className="bg-slate-900 rounded-2xl p-8 text-white mt-10">
                ...
                <p className="text-slate-300 text-sm">Мастер приедет за 30 минут, проведёт бесплатную диагностику и предложит честную смету. Работаем во всех районах Алматы 24/7.</p>
              </div>
            </div>
