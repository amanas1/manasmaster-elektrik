        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <article className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
            ...
            <div className="p-8 md:p-12 lg:px-16 text-gray-700 font-medium leading-relaxed">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mt-10 mb-4">Признак №1: Мигающий свет</h2>
              <p className="mb-4">
              ...
              <div className="bg-red-50 border-l-4 border-[#DC2626] p-6 rounded-r-2xl my-8">
                <div className="flex items-start gap-3">
                  ...
                  <p className="m-0 font-medium">Ваша проводка старше 20 лет? Независимо от признаков — проведите профилактическую диагностику. Алюминиевые провода имеют ограниченный срок службы. Мастер оценит состояние проводки и предложит понятное решение.</p>
                </div>
              </div>
              ...
              <div className="bg-slate-900 rounded-2xl p-8 text-white mt-10">
                ...
                <p className="text-slate-300 text-sm">Мастер согласует время выезда, проведёт осмотр и предложит честную смету. Работаем во всех районах Алматы.</p>
              </div>
            </div>
