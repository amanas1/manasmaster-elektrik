...
const Blog = () => {
  ...
  const posts = [
    ...
    {
      id: 13,
      title: "Как защитить квартиру от потопа: защита от протечек",
      excerpt: "Полное руководство по выбору и монтажу систем Neptun, Аквасторож и Gidrolock. Как датчики протечки и электрокраны спасают ремонт.",
      date: "20 Марта 2024",
      author: "Мастер Манас",
      image: "https://images.unsplash.com/photo-1584622650111-993a426fbf0a?auto=format&fit=crop&q=80&w=800",
      category: "Сантехника",
      link: "/blog/plumbing-leaks"
    },
    {
      id: 14,
      title: "Жесткая вода в Алматы: как сберечь сантехнику",
      excerpt: "Почему горная вода быстро выводит из строя ТЭНы, смесители и трубы? Способы очистки, выбор магистральных фильтров и умягчителей.",
      date: "21 Марта 2024",
      author: "Мастер Манас",
      image: "https://images.unsplash.com/photo-1504148455328-c376907d081c?auto=format&fit=crop&q=80&w=800",
      category: "Сантехника",
      link: "/blog/plumbing-water"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      <SEO 
        ...
        keywords="электрик Алматы статьи, советы электрика, электромонтажные работы Алматы, безопасность электрики, ремонт проводки советы"
