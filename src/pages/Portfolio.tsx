  ...
  const projects = [
    {
      ...
      description: "Выполнен демонтаж старой алюминиевой проводки и монтаж новой медной линии. Установка нового щитка, розеток и выключателей во всей квартире.",
      time: "4 дня",
      price: "180 000 ₸",
    ...
    },
    {
      ...
      description: "Штробление стен, прокладка кабеля в гофре и установка подрозетников по проекту. Подбор кабеля под нагрузку и схему помещения.",
      time: "5 дней",
      price: "220 000 ₸",
    },
    {
